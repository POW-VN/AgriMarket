  ...
  return (
    <aside className="admin-sidebar">
      ...
      <nav className="admin-nav-menu">
        <button
          className={`admin-nav-item ${activeItem === "dashboard" ? "active" : ""}`}
          onClick={() => handleShowToast("Chức năng Bảng điều khiển đang phát triển.")}
        >
        ...
        <button
          className={`admin-nav-item ${activeItem === "users" ? "active" : ""}`}
        ...
        <button
          className={`admin-nav-item ${activeItem === "farmer" ? "active" : ""}`}
          onClick={() => handleShowToast("Chức năng quản lý nông dân đang phát triển.")}
        >
          <span className="admin-nav-icon">
        ...
        <button
          className={`admin-nav-item ${activeItem === "products" ? "active" : ""}`}
          onClick={() => {
            if (onProductsClick) {
              onProductsClick();
            }
        ...
        <button
          className={`admin-nav-item ${activeItem === "categories" ? "active" : ""}`}
          onClick={() => handleShowToast("Chức năng quản lý danh mục đang phát triển.")}
        >
          <span className="admin-nav-icon">
        ...
        <button
          className={`admin-nav-item ${activeItem === "orders" ? "active" : ""}`}
        ...
        <button
          className={`admin-nav-item ${activeItem === "transactions" ? "active" : ""}`}
          onClick={() => handleShowToast("Chức năng giao dịch đang phát triển.")}
        >
          <span className="admin-nav-icon">
        ...
        <button
          className={`admin-nav-item ${activeItem === "complaints" ? "active" : ""}`}
          onClick={() => {
            if (onComplaintsClick) {
              onComplaintsClick();
            }
        ...
        <button
          className={`admin-nav-item ${activeItem === "reports" ? "active" : ""}`}
        ...
        <button
          className={`admin-nav-item ${activeItem === "livestreams" ? "active" : ""}`}
        ...
        <button
          className={`admin-nav-item ${activeItem === "ai" ? "active" : ""}`}
          onClick={() => handleShowToast("Chức năng AI Monitoring đang phát triển.")}
        >
          <span className="admin-nav-icon">
        ...
        <button
          className={`admin-nav-item ${activeItem === "notifications" ? "active" : ""}`}
        ...
        <button
          className={`admin-nav-item ${activeItem === "stats" ? "active" : ""}`}
          onClick={() => handleShowToast("Chức năng thống kê hệ thống đang phát triển.")}
        >
          <span className="admin-nav-icon">
        ...
        <button
          className={`admin-nav-item ${activeItem === "settings" ? "active" : ""}`}
          onClick={() => handleShowToast("Chức năng cài đặt đang phát triển.")}
        >
          <span className="admin-nav-icon">
        ...
        <button className="admin-nav-item logout-item" onClick={handleLogout}>
          <span className="admin-nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="admin-nav-icon-svg"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
          </span>
          Đăng xuất
        </button>
      </nav>
